...
python train.py --epochs 60 --dataset MaskSplitByProfileDataset --augmentation BaseAugmentation --model VGGFace --model_param false --optimizer SGD --name VGGFace_Ep60_patience15_SplitProf_Downsample_BaseAug_WeightedCEnSamplev0_SGD_AGE --label age
python train.py --epochs 60 --dataset MaskSplitByProfileDataset --augmentation BaseAugmentation --model VGGFace --model_param false --optimizer SGD --name VGGFace_Ep60_patience15_SplitProf_Downsample_BaseAug_WeightedCEnSamplev0_SGD_GENDER --label gender
python train.py --epochs 60 --dataset MaskSplitByProfileDataset --augmentation BaseAugmentation --model VGGFace --model_param false --optimizer SGD --name VGGFace_Ep60_patience15_SplitProf_Downsample_BaseAug_WeightedCEnSamplev0_SGD_MASK --label mask

python train.py --epochs 60 --dataset MaskSplitByProfileDataset --augmentation BaseAugmentation --model VGGFace --model_param true --optimizer SGD --name VGGFace_Feature_Ep60_patience15_SplitProf_Downsample_BaseAug_WeightedCEnSamplev0_SGD_AGE --label age
python train.py --epochs 60 --dataset MaskSplitByProfileDataset --augmentation BaseAugmentation --model VGGFace --model_param true --optimizer SGD --name VGGFace_Feature_Ep60_patience15_SplitProf_Downsample_BaseAug_WeightedCEnSamplev0_SGD_GENDER --label gender
python train.py --epochs 60 --dataset MaskSplitByProfileDataset --augmentation BaseAugmentation --model VGGFace --model_param true --optimizer SGD --name VGGFace_Feature_Ep60_patience15_SplitProf_Downsample_BaseAug_WeightedCEnSamplev0_SGD_MASK --label mask

python inference.py --model VGGFace --model_param false --label age gender mask --output_filename VGGFace_Ep60_patience15_SplitProf_Downsample_CustAugv1_WeightedCEnSamplev1_SGD_AGM-ijkimmy --model_dir ./model/age/VGGFace_Ep60_patience15_SplitProf_Downsample_CustAugv1_WeightedCEnSamplev1_SGD_AGE ./model/gender/VGGFace_Ep60_patience15_SplitProf_Downsample_CustAugv1_WeightedCEnSamplev1_SGD_GENDER ./model/mask/VGGFace_Ep60_patience15_SplitProf_Downsample_CustAugv1_WeightedCEnSamplev1_SGD_MASK
python inference.py --model VGGFace --model_param true --label age gender mask --output_filename VGGFace_Feature_Ep60_patience15_SplitProf_Downsample_CustAugv1_WeightedCEnSamplev1_SGD_AGM-ijkimmy --model_dir ./model/age/VGGFace_Feature_Ep60_patience15_SplitProf_Downsample_CustAugv1_WeightedCEnSamplev1_SGD_AGE ./model/gender/VGGFace_Feature_Ep60_patience15_SplitProf_Downsample_CustAugv1_WeightedCEnSamplev1_SGD_GENDER ./model/mask/VGGFace_Feature_Ep60_patience15_SplitProf_Downsample_CustAugv1_WeightedCEnSamplev1_SGD_MASK

python train.py --epochs 60 --dataset MaskSplitByProfileDataset --augmentation BaseAugmentation --model PretrainedModels --model_param vgg false --optimizer SGD --name Vgg_Ep60_patience15_SplitProf_Downsample_BaseAug_WeightedCEnSamplev0_SGD_AGE --label age
python train.py --epochs 60 --dataset MaskSplitByProfileDataset --augmentation BaseAugmentation --model PretrainedModels --model_param vgg false --optimizer SGD --name Vgg_Ep60_patience15_SplitProf_Downsample_BaseAug_WeightedCEnSamplev0_SGD_GENDER --label gender
python train.py --epochs 60 --dataset MaskSplitByProfileDataset --augmentation BaseAugmentation --model PretrainedModels --model_param vgg false --optimizer SGD --name Vgg_Ep60_patience15_SplitProf_Downsample_BaseAug_WeightedCEnSamplev0_SGD_MASK --label mask
python inference.py --model PretrainedModels --model_param vgg false --label age gender mask --output_filename Vgg_Ep60_patience15_SplitProf_Downsample_BaseAug_WeightedCEnSamplev0_SGD_AGE-ijkimmy --model_dir ./model/age/Vgg_Ep60_patience15_SplitProf_Downsample_BaseAug_WeightedCEnSamplev0_SGD_AGE ./model/gender/Vgg_Ep60_patience15_SplitProf_Downsample_BaseAug_WeightedCEnSamplev0_SGD_GENDER ./model/mask/Vgg_Ep60_patience15_SplitProf_Downsample_BaseAug_WeightedCEnSamplev0_SGD_MASK